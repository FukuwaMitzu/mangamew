...
export default function MangaPage({ id, title, altTitle, tags, authors, artists, cover, description, status, year}) {
    ...
    const [chapterContainerRef] = useLazyFetching(feedApi, (fetchData)=>{
        setFeedApiParams({ id: id, offset: fetchData.offset, limit: fetchData.limit});
    });
    ...
    return (
        <Fragment>
            ...
            <div className="lg:mt-10 py-10 gap-5 grid lg:grid-cols-12 bg-dominant">
                <div className="w-full lg:sticky lg:top-20 lg:max-h-[80vh] lg:h-max lg:border-r-grey lg:col-span-5 lg:overscroll-contain lg:overflow-y-auto">
