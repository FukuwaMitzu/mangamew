...
const ChapterList = dynamic(() => import("src/components/cards/ChapterList"), {ssr:false, loading: ()=><Loading></Loading>});
const ReactMarkdown = dynamic(()=>import("react-markdown"), {ssr:false, loading: ()=><Loading></Loading>});
        ...
        <Fragment>
            ...
            <div className="relative min-w-0 w-full sm:p-5">
                ...
                <div className="flex flex-col gap-x-12 gap-y-3 md:flex-row max-w-5xl m-auto relative">
                    ...
                    <div className="flex flex-col flex-1 gap-y-2 sm:gap-0 p-3 sm:p-5 rounded-md glassbox">
                        ...
                        <div className="flex gap-3 justify-start sm:justify-end mt-3 sm:mt-10 sm:pb-5 items-center">
                            {
                                firstChapterId !== "" &&
                            ...
                            <FollowButton mangaId={id}></FollowButton>
                        </div>
                    </div>
                </div>
            </div>
            <div className="lg:mt-10 py-10 gap-5 grid lg:grid-cols-12 bg-dominant">
                ...
                <div className="lg:col-span-7">
                    ...
                    {
                        feedApi.loading && <Loading></Loading> 
                    }               
                    {
                        !feedApi.loading &&
